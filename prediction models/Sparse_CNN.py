...
train_matrix_x = np.nan_to_num(train_matrix_x, nan=0.0)
val_matrix_x = np.nan_to_num(val_matrix_x, nan=0.0)
test_matrix_x = np.nan_to_num(test_matrix_x, nan=0.0)
...
# look at L1-Norms to check sparsity
